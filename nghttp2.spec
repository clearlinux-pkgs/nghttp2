...
Version  : 1.32.1
Release  : 37
URL      : https://github.com/nghttp2/nghttp2/releases/download/v1.32.1/nghttp2-1.32.1.tar.bz2
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.32.1/nghttp2-1.32.1.tar.bz2
...
%prep
%setup -q -n nghttp2-1.32.1
pushd ..
cp -a nghttp2-1.32.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1535214577
export AR=gcc-ar
...
/usr/lib64/libnghttp2.so.14.16.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.16.3
