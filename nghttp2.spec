...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.37.0/nghttp2-1.37.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.37.0
pushd ..
cp -a nghttp2-1.37.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1552067028
export AR=gcc-ar
...
/usr/lib64/libnghttp2.so.14.17.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.17.2
