...
%package staticdev32
Summary: staticdev32 components for the nghttp2 package.
Group: Default
Requires: nghttp2-dev = %{version}-%{release}

%description staticdev32
staticdev32 components for the nghttp2 package.
...
%setup -q -n nghttp2-1.65.0
cd %{_builddir}/nghttp2-1.65.0
pushd ..
cp -a nghttp2-1.65.0 build32
popd
pushd ..
cp -a nghttp2-1.65.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742443261
...
%configure  --disable-python-bindings   --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  %{?_smp_mflags}
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp2.so.14.28.4
/usr/lib64/libnghttp2.so.14
/usr/lib64/libnghttp2.so.14.28.4

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.28.4
