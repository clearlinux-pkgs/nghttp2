...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.41.0/nghttp2-1.41.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.41.0
cd %{_builddir}/nghttp2-1.41.0
pushd ..
cp -a nghttp2-1.41.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594756187
...
cp %{_builddir}/nghttp2-1.41.0/COPYING %{buildroot}/usr/share/package-licenses/nghttp2/7f6f3c0c08925232459e499d66231cb5da01d811
cp %{_builddir}/nghttp2-1.41.0/doc/_exts/sphinxcontrib/LICENSE.rubydomain %{buildroot}/usr/share/package-licenses/nghttp2/2e3d96196666de3d8582c67fcdc7804f28e1fe0c
cp %{_builddir}/nghttp2-1.41.0/third-party/mruby/LICENSE %{buildroot}/usr/share/package-licenses/nghttp2/c9082c3edb3c2a747835f63d358337c4e05371ed
pushd ../build32/
%make_install32
