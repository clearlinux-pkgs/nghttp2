...
Version  : 1.35.0
Release  : 44
URL      : https://github.com/nghttp2/nghttp2/releases/download/v1.35.0/nghttp2-1.35.0.tar.bz2
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.35.0/nghttp2-1.35.0.tar.bz2
...
%prep
%setup -q -n nghttp2-1.35.0
pushd ..
cp -a nghttp2-1.35.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1542987488
export AR=gcc-ar
