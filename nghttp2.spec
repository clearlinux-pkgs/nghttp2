...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.58.0/nghttp2-1.58.0.tar.xz
Source1  : https://github.com/nghttp2/nghttp2/releases/download/v1.58.0/nghttp2-1.58.0.tar.xz.asc
...
%prep
%setup -q -n nghttp2-1.58.0
cd %{_builddir}/nghttp2-1.58.0
pushd ..
cp -a nghttp2-1.58.0 build32
popd
pushd ..
cp -a nghttp2-1.58.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698418642
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp2.so.14.25.1
/usr/lib64/libnghttp2.so.14
/usr/lib64/libnghttp2.so.14.25.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.25.1
