...
%prep
%setup -q -n nghttp2-1.46.0
cd %{_builddir}/nghttp2-1.46.0
pushd ..
cp -a nghttp2-1.46.0 build32
popd
...
cp %{_builddir}/nghttp2-1.46.0/doc/_exts/rubydomain/LICENSE.rubydomain %{buildroot}/usr/share/package-licenses/nghttp2/2e3d96196666de3d8582c67fcdc7804f28e1fe0c
cp %{_builddir}/nghttp2-1.46.0/third-party/mruby/LICENSE %{buildroot}/usr/share/package-licenses/nghttp2/604c3e30211a816ca914b6ed1a3854d2ea360552
pushd ../build32/
%make_install32
...
/usr/lib64/libnghttp2.so.14.21.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.21.1
