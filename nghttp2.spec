...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.18.1/nghttp2-1.18.1.tar.xz
...
%prep
%setup -q -n nghttp2-1.18.1
pushd ..
cp -a nghttp2-1.18.1 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483643537
...
/usr/lib64/libnghttp2.so.14.12.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.12.3
