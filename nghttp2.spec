...
Version  : 1.20.0
Release  : 14
URL      : http://github.com/nghttp2/nghttp2/releases/download/v1.20.0/nghttp2-1.20.0.tar.xz
Source0  : http://github.com/nghttp2/nghttp2/releases/download/v1.20.0/nghttp2-1.20.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.20.0
pushd ..
cp -a nghttp2-1.20.0 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1488392370
...
/usr/lib64/libnghttp2.so.14.13.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.13.0
