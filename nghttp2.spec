...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.45.1/nghttp2-1.45.1.tar.xz
...
%prep
%setup -q -n nghttp2-1.45.1
cd %{_builddir}/nghttp2-1.45.1
pushd ..
cp -a nghttp2-1.45.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632252066
...
cp %{_builddir}/nghttp2-1.45.1/COPYING %{buildroot}/usr/share/package-licenses/nghttp2/7f6f3c0c08925232459e499d66231cb5da01d811
cp %{_builddir}/nghttp2-1.45.1/doc/_exts/rubydomain/LICENSE.rubydomain %{buildroot}/usr/share/package-licenses/nghttp2/2e3d96196666de3d8582c67fcdc7804f28e1fe0c
cp %{_builddir}/nghttp2-1.45.1/third-party/mruby/LICENSE %{buildroot}/usr/share/package-licenses/nghttp2/604c3e30211a816ca914b6ed1a3854d2ea360552
pushd ../build32/
%make_install32
...
/usr/lib32/libnghttp2.so.14.21.0
