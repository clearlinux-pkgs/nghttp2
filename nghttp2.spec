...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.42.0/nghttp2-1.42.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.42.0
cd %{_builddir}/nghttp2-1.42.0
pushd ..
cp -a nghttp2-1.42.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606163498
...
cp %{_builddir}/nghttp2-1.42.0/COPYING %{buildroot}/usr/share/package-licenses/nghttp2/7f6f3c0c08925232459e499d66231cb5da01d811
cp %{_builddir}/nghttp2-1.42.0/doc/_exts/sphinxcontrib/LICENSE.rubydomain %{buildroot}/usr/share/package-licenses/nghttp2/2e3d96196666de3d8582c67fcdc7804f28e1fe0c
cp %{_builddir}/nghttp2-1.42.0/third-party/mruby/LICENSE %{buildroot}/usr/share/package-licenses/nghttp2/604c3e30211a816ca914b6ed1a3854d2ea360552
pushd ../build32/
%make_install32
