...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.49.0/nghttp2-1.49.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.49.0
cd %{_builddir}/nghttp2-1.49.0
pushd ..
cp -a nghttp2-1.49.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661191063
...
/usr/lib64/libnghttp2.so.14.23.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.23.0
