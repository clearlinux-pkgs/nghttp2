...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.27.0/nghttp2-1.27.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.27.0
pushd ..
cp -a nghttp2-1.27.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1508952767
export AR=gcc-ar
