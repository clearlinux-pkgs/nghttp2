...
Version  : 1.21.0
Release  : 15
URL      : http://github.com/nghttp2/nghttp2/releases/download/v1.21.0/nghttp2-1.21.0.tar.xz
Source0  : http://github.com/nghttp2/nghttp2/releases/download/v1.21.0/nghttp2-1.21.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.21.0
pushd ..
cp -a nghttp2-1.21.0 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490649760
...
/usr/lib32/libnghttp2.so.14.13.1
