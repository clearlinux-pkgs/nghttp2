...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.30.0/nghttp2-1.30.0.tar.bz2
...
%prep
%setup -q -n nghttp2-1.30.0
pushd ..
cp -a nghttp2-1.30.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1517676676
export AR=gcc-ar
...
/usr/lib64/libnghttp2.so.14.15.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.15.2
