...
Version  : 1.52.0
Release  : 70
URL      : https://github.com/nghttp2/nghttp2/releases/download/v1.52.0/nghttp2-1.52.0.tar.xz
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.52.0/nghttp2-1.52.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.52.0
cd %{_builddir}/nghttp2-1.52.0
pushd ..
cp -a nghttp2-1.52.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676305781
...
cp %{_builddir}/nghttp2-%{version}/third-party/mruby/LICENSE %{buildroot}/usr/share/package-licenses/nghttp2/84e4e4aee335dc4057ad097522ee8777adc0e6e7 || :
pushd ../build32/
%make_install32
...
/usr/lib64/libnghttp2.so.14.24.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.24.1
...
/usr/share/package-licenses/nghttp2/84e4e4aee335dc4057ad097522ee8777adc0e6e7
