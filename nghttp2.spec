...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.21.1/nghttp2-1.21.1.tar.xz
...
%prep
%setup -q -n nghttp2-1.21.1
pushd ..
cp -a nghttp2-1.21.1 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491758938
