...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.23.1/nghttp2-1.23.1.tar.xz
...
%prep
%setup -q -n nghttp2-1.23.1
pushd ..
cp -a nghttp2-1.23.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1496328617
export AR=gcc-ar
