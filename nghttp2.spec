...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.48.0/nghttp2-1.48.0.tar.xz
...
%prep
%setup -q -n nghttp2-1.48.0
cd %{_builddir}/nghttp2-1.48.0
pushd ..
cp -a nghttp2-1.48.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656094775
...
cp %{_builddir}/nghttp2-1.48.0/COPYING %{buildroot}/usr/share/package-licenses/nghttp2/7f6f3c0c08925232459e499d66231cb5da01d811
cp %{_builddir}/nghttp2-1.48.0/doc/_exts/rubydomain/LICENSE.rubydomain %{buildroot}/usr/share/package-licenses/nghttp2/2e3d96196666de3d8582c67fcdc7804f28e1fe0c
pushd ../build32/
%make_install32
...
/usr/lib64/libnghttp2.so.14.22.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.22.0
