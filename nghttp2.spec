...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.60.0/nghttp2-1.60.0.tar.xz
Source1  : https://github.com/nghttp2/nghttp2/releases/download/v1.60.0/nghttp2-1.60.0.tar.xz.asc
...
%prep
%setup -q -n nghttp2-1.60.0
cd %{_builddir}/nghttp2-1.60.0
pushd ..
cp -a nghttp2-1.60.0 build32
popd
pushd ..
cp -a nghttp2-1.60.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709595273
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp2.so.14.27.0
/usr/lib64/libnghttp2.so.14
/usr/lib64/libnghttp2.so.14.27.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.27.0
