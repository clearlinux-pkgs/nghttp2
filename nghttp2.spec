...
Version  : 1.33.0
Release  : 38
URL      : https://github.com/nghttp2/nghttp2/releases/download/v1.33.0/nghttp2-1.33.0.tar.bz2
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.33.0/nghttp2-1.33.0.tar.bz2
...
%prep
%setup -q -n nghttp2-1.33.0
pushd ..
cp -a nghttp2-1.33.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1535901410
export AR=gcc-ar
...
/usr/lib64/libnghttp2.so.14.17.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.17.0
