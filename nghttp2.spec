...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.63.0/nghttp2-1.63.0.tar.gz
Source1  : https://github.com/nghttp2/nghttp2/releases/download/v1.63.0/nghttp2-1.63.0.tar.gz.asc
...
%setup -q -n nghttp2-1.63.0
cd %{_builddir}/nghttp2-1.63.0
pushd ..
cp -a nghttp2-1.63.0 build32
popd
pushd ..
cp -a nghttp2-1.63.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724867594
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp2.so.14.28.2
/usr/lib64/libnghttp2.so.14
/usr/lib64/libnghttp2.so.14.28.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnghttp2.so.14
/usr/lib32/libnghttp2.so.14.28.2
