...
Source0  : https://github.com/nghttp2/nghttp2/releases/download/v1.35.1/nghttp2-1.35.1.tar.bz2
...
%prep
%setup -q -n nghttp2-1.35.1
pushd ..
cp -a nghttp2-1.35.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1544377951
export AR=gcc-ar
